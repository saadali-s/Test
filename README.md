...
public class DList<T extends Comparable<T>> implements IList<T>, Cloneable {
	...
	/** A reference to the header node of the list. */
	private Node<T> header = null;
	
	/** A reference to the trailer node of the list. */
	 ...
	 * @return A cloned DList instance.
	 */
	@Override
	 ...
	 * @param elem The node to insert after.
	 ...
	 * @param elem The node to insert before.
	 * @param item The item to insert.
	 * @return The newly created node.
	 */
	@Override
	 ...
	 * @return A new IList without the first element.
	 */
	public IList<T> tail() {
	 ...
	 * @return A formatted string of list elements.
	 */
	@Override
	public String toString() {
	 ...
	 * @return A new DList containing smaller elements.
	 */
	 ...
	 * @param element The element to compare against.
	 * @return A new DList containing greater elements.
	 */
	 ...
	 * @param element The element to compare against.
	 * @return A new DList containing equal elements.
	 */
